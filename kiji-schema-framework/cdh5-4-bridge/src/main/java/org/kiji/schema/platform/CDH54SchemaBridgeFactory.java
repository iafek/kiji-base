 ...
 */
@ApiAudience.Private
public final class CDH54SchemaBridgeFactory extends SchemaPlatformBridgeFactory {
    ...
    try {
      Class<? extends SchemaPlatformBridge> bridgeClass =
          (Class<? extends SchemaPlatformBridge>) Class.forName(
              "org.kiji.schema.platform.CDH54SchemaBridge");
